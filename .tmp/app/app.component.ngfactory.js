...
var _View_MyApp_Host0 = (function (_super) {
    ...
    _View_MyApp_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._MyApp_0_4 = new import3.MyApp(this.parentInjector.get(import8.Platform), this.parentInjector.get(import9.Push), this.parentInjector.get(import10.Http));
...
var _View_MyApp0 = (function (_super) {
    ...
    _View_MyApp0.prototype.createInternal = function (rootSelector) {
        ...
        this._appEl_0 = new import2.AppElement(0, null, this, this._el_0);
        var compView_0 = import14.viewFactory_Nav0(this.viewUtils, this.injector(0), this._appEl_0);
        this._Nav_0_4 = new import13.Nav(this.parentInjector.get(import15.ViewController, null), this.parentInjector.get(import16.NavControllerBase, null), this.parentInjector.get(import17.App), this.parentInjector.get(import18.Config), this.parentInjector.get(import19.Keyboard), new import20.ElementRef(this._el_0), this.parentInjector.get(import21.NgZone), this.renderer, this.parentInjector.get(import22.ComponentFactoryResolver), this.parentInjector.get(import23.GestureController), this.parentInjector.get(import24.TransitionController), this.parentInjector.get(import25.DeepLinker, null));
    ...
    _View_MyApp0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import13.Nav) && (0 === requestNodeIndex))) {
